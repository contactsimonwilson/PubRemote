...
lv_obj_t * ui_PairingScreen1;
lv_obj_t * ui_PairingScreenContent1;
lv_obj_t * ui_PairingScreenHeader1;
lv_obj_t * ui_PairingScreenBody1;
lv_obj_t * ui_Label3;
lv_obj_t * ui_Label5;
lv_obj_t * ui_PairingScreenFooter1;
void ui_event_PairingScreenMainActionButton1(lv_event_t * e);
lv_obj_t * ui_PairingScreenMainActionButton1;
lv_obj_t * ui_PairingScreenMainActionButtonLabel1;


// SCREEN: ui_CalibrationScreen1
void ui_CalibrationScreen1_screen_init(void);
lv_obj_t * ui_CalibrationScreen1;
lv_obj_t * ui_CalibrationScreenContent1;
lv_obj_t * ui_CalibrationScreenheader1;
lv_obj_t * ui_CalibrationScreenBody1;
lv_obj_t * ui_Label1;
lv_obj_t * ui_CalibrationScreenFooter1;
void ui_event_CalibrationScreenMainActionButton1(lv_event_t * e);
lv_obj_t * ui_CalibrationScreenMainActionButton1;
lv_obj_t * ui_CalibrationScreenMainActionButtonLabel1;
...
void ui_event_PairingScreenMainActionButton(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_PairingScreen1, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_PairingScreen1_screen_init);
        StartPairing(e);
    }
}
void ui_event_SettingsScreen(lv_event_t * e)
...
void ui_event_CalibrationScreenMainActionButton(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(&ui_CalibrationScreen1, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_CalibrationScreen1_screen_init);
    }
}
