...
extern "C"
{
   ...
   * @param[in]  panel_dev_config General panel device configuration (Use `vendor_config` to select QSPI interface or
   * override default initialization commands)
