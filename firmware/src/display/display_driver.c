...
#elif DISP_CO5300
  #include "co5300/display_driver_co5300.h"
#elif DISP_ST7789
...
#elif DISP_CO5300
  return co5300_test_display_communication(io_handle);
#elif DISP_ST7789
...
#elif DISP_CO5300
  return co5300_display_driver_preinit();
#elif DISP_ST7789
...
#elif DISP_CO5300
  return co5300_set_display_brightness(io_handle, brightness);
#elif DISP_ST7789
