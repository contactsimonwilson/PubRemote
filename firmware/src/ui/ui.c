...
lv_obj_t * ui_RemoteModeContainer;
lv_obj_t * ui_RemoteModeText;
void ui_event_PrimaryStat(lv_event_t * e);
lv_obj_t * ui_PrimaryStat;
lv_obj_t * ui_PrimaryStatUnit;
lv_obj_t * ui_SecondaryStatPaddingContainer;
...
lv_obj_t * ui_PairingHeaderLabel;
...
lv_obj_t * ui_InvertXContainer;
lv_obj_t * ui_InvertXSwitch;
lv_obj_t * ui_InvertXLabel;
lv_obj_t * ui_InvertYContainer;
lv_obj_t * ui_InvertYSwitch;
lv_obj_t * ui_InvertYLabel;
lv_obj_t * ui_InvertXYContainer;
lv_obj_t * ui_InvertXYSwitch;
lv_obj_t * ui_InvertXYLabel;
