...
void ui_MenuScreen_screen_init(void) {
  ...
  lv_obj_set_style_text_color(ui_MenuBackButtonLabel, lv_color_hex(0x000000), LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui_MenuConnectButtonLabel, lv_color_hex(0x000000), LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui_MenuAboutButtonLabel, lv_color_hex(0x000000), LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui_MenuSettingsButtonLabel, lv_color_hex(0x000000), LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui_MenuCalibrateButtonLabel, lv_color_hex(0x000000), LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui_MenuPairButtonLabel, lv_color_hex(0x000000), LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(ui_MenuShutdownButtonLabel, lv_color_hex(0x000000), LV_STATE_DEFAULT);
