...
void ui_MenuScreen_screen_init(void) {
  ...
  lv_obj_set_style_text_color(ui_MenuScreen, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_opa(ui_MenuScreen, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_remove_flag(ui_MenuBody,
