...
void ui_UpdateScreen_screen_init(void) {
  ...
  lv_obj_add_event_cb(ui_UpdateScreen, scr_unloaded_delete_cb, LV_EVENT_SCREEN_UNLOADED,
  ...
  lv_obj_set_style_text_color(ui_UpdateScreen, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_opa(ui_UpdateScreen, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
