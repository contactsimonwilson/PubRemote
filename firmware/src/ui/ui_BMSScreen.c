...
lv_obj_t * ui_BMSScreen = NULL;
lv_obj_t * ui_BMSContent = NULL;
lv_obj_t * ui_BMSHeader = NULL;
lv_obj_t * ui_BMSHeaderLabel = NULL;
lv_obj_t * ui_BMSBody = NULL;
lv_obj_t * ui_BMSGroupHeadingLabel = NULL;
lv_obj_t * ui_BMSDataBar = NULL;
lv_obj_t * ui_BMSDataValueBar = NULL;
lv_obj_t * ui_BMSDataValueLabel = NULL;
lv_obj_t * ui_BMSFooter = NULL;
lv_obj_t * ui_BMSMainActionButton = NULL;
lv_obj_t * ui_BMSMainActionButtonLabel = NULL;
// event funtions
...
void ui_BMSScreen_screen_destroy(void)
{
    if(ui_BMSScreen) lv_obj_del(ui_BMSScreen);

    // NULL screen variables
    ui_BMSScreen = NULL;
    ui_BMSContent = NULL;
    ui_BMSHeader = NULL;
    ui_BMSHeaderLabel = NULL;
    ui_BMSBody = NULL;
    ui_BMSGroupHeadingLabel = NULL;
    ui_BMSDataBar = NULL;
    ui_BMSDataValueBar = NULL;
    ui_BMSDataValueLabel = NULL;
    ui_BMSFooter = NULL;
    ui_BMSMainActionButton = NULL;
    ui_BMSMainActionButtonLabel = NULL;
