...
lv_obj_remove_flag( ui_StatsContent, LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_MOMENTUM );    /// Flags
...
lv_obj_remove_flag( ui_StatsHeader, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
lv_obj_remove_flag( ui_StatsBody, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
lv_obj_remove_flag( ui_SecondaryStat, LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM | LV_OBJ_FLAG_SCROLL_CHAIN );    /// Flags
...
lv_obj_remove_flag( ui_StatsFooter, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
