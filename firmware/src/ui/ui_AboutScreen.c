...
void ui_AboutScreen_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_AboutBody, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLL_ELASTIC |
    ...
    ui_object_set_themeable_style_property(ui_AboutMainActionButtonLabel, LV_PART_MAIN | LV_STATE_DEFAULT,
    ...
    ui_object_set_themeable_style_property(ui_UpdateButtonLabel, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_COLOR,
                                           _ui_theme_color_Text);
    ui_object_set_themeable_style_property(ui_UpdateButtonLabel, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA,
